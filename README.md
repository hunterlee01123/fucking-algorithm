...
<generatorConfiguration>
    ...
    <context id="Mybatis3Context" targetRuntime="MyBatis3">
        ...
        <javaModelGenerator targetPackage="model" targetProject="D:/code/imooc-springboot-starter-master/src/main/java">
            <property name="enableSubPackages" value="true"/>
            <property name="trimStrings" value="true"/>
        </javaModelGenerator>

        <sqlMapGenerator targetPackage="mapperxml" targetProject="D:/code/imooc-springboot-starter-master/src/main/resources">
            <property name="enableSubPackages" value="true"/>
        </sqlMapGenerator>

        <javaClientGenerator type="XMLMAPPER" targetPackage="mapper" targetProject="D:/code/imooc-springboot-starter-master/src/main/java">
            <property name="enableSubPackages" value="true"/>
        </javaClientGenerator>
